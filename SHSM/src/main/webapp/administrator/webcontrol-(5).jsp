        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
               <ul class="nav nav-sidebar">
                    ...
                    <li><a href="webcontrol-(1).jsp">會員管理 (會員列表)</a></li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div id="reportechack-dataresource">
                    <iframe src="reportechack-dataresource.jsp" frameborder="0" width="1200" height="800" scrolling="no" style="margin: 30px 0 0 0 "></iframe>
                </div>
                <!--檢舉清單 end-->
