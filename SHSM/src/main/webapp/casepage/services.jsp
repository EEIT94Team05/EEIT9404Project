			...
			<div class="page-content">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						...
						<!-- Accordion -->
						<div class="panel-group" id="memberdata">
							<!-- Start 1 -->
							<div class="panel panel-default" style="border: 0px">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#memberdata"
											href="#memberdata-one"> <i
											class="fa fa-angle-up control-icon"></i> <i
											class="fa fa-desktop"></i> <input type="text" value="基本資料修改"
											style="border: 0px; margin: 0 0 10px 10px"
											readonly="readonly">
								...
								<div id="memberdata-one" class="panel-collapse collapse in">
									<div class="panel-body"></div>
									<!--表單資料接收 這邊噢   姓名修改這邊 -->
									<form action="">
										<p>
											<input type="text" value="編號:A0000000009"
												style="border: 0px;" href="#" readonly="on">
										<p>
											姓名: <input type="text" max-size="4" value="點擊我修改"
												style="border: 0px" href="#">
										</p>
										<p>
											信箱: <input type="email" value="點擊我修改" style="border: 0px"
												href="#">
										</p>
										<p>
											地址: <input type="text" value="點擊我修改" style="border: 0px"
												href="#">
										</p>
										<p>
											手機: <input type="text" value="點擊我修改" style="border: 0px"
												href="#">
										</p>
										<button type="submit" value="">送出修改</button>
										<button type="reset" value="">取消</button>
										</p>
									</form>
								</div>
							</div>
